...
{
    public class ProductListItemsController : Controller
    {
        private readonly ChipinDbContext _context;

        public ProductListItemsController(ChipinDbContext context)
        {
            _context = context;
        }
        ...
        {
            var chipinDbContext = _context.ProductListItems.Include(p => p.ExternalProduct).Include(p => p.Product).Include(p => p.ProductListWallet);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            await DeleteConfirmed(productListItem.ChipinProductListEntryId);
