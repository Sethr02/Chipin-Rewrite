...
{
    public class ProductListWalletsDatabaseController : Controller
    {
        private readonly ChipinDbContext _context;

        public ProductListWalletsDatabaseController(ChipinDbContext context)
        {
            _context = context;
        }
        ...
        {
            var chipinDbContext = _context.ProductListWallets;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var productListWallets = await _context.ProductListWallets.FindAsync(id);
            if (productListWallets != null)
            {
                _context.ProductListWallets.Remove(productListWallets);
            }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var productListItem = await _context.ProductListWallets
            ...
            await DeleteConfirmed(productListItem.ProductListWalletId);
